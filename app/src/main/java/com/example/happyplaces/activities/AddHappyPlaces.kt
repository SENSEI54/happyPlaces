...
class AddHappyPlaces : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setSupportActionBar(binding.toolIdAddPlaces)
        supportActionBar?.setDisplayHomeAsUpEnabled(true)
        binding.toolIdAddPlaces.setNavigationOnClickListener {
        ...
        if (intent.hasExtra(MainActivity.EXTRA_DETAILS_OF_HAPPY_PLACE)) {
            mHappyPlaceDetails =
                intent.getSerializableExtra(MainActivity.EXTRA_DETAILS_OF_HAPPY_PLACE) as HappyPlaceModel
        }
    ...
    override fun onClick(v: View?) {
        when (v!!.id) {
            R.id.et_date -> {
                DatePickerDialog(
                    this@AddHappyPlaces, dateSetListener,
            ...
            if (requestCode == GALLERY) {
                if (data != null) {
                    ...
                    try {
                        ...
                        e.printStackTrace()
                        Toast.makeText(this@AddHappyPlaces, "Failed!", Toast.LENGTH_SHORT)
                            .show()
                    }
                }
